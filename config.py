...
OTP_SERVICE_ACTIVATED = SECRETS['OTP_SERVICE_ACTIVATED']
OTP_SERVICE_API_URL = SECRETS['OTP_SERVICE_API_URL']
OTP_SERVICE_USERNAME = SECRETS['OTP_SERVICE_USERNAME']
OTP_SERVICE_USER_SENDER = SECRETS['OTP_SERVICE_USER_SENDER']
OTP_SERVICE_API_KEY = SECRETS['OTP_SERVICE_API_KEY']
