...
from data.dbapis.club_services_horse_shoeing.write_queries import create_new_horse_shoeing_service_booking
...
def create_horse_shoeing_service_booking_logic(booking: dict, club_id: str, user_id: str):
    log.info(f'creating a booking for user {user_id} with club {club_id} for horse shoeing with details {booking}')

    horse_shoeing_service_id_for_club = get_existing_horse_shoeing_service_for_club(club_id=club_id)

    booking = HorseShoeingBooking(
        user_id=user_id,
        horse_shoeing_service_id=horse_shoeing_service_id_for_club['id'],
    ...
    result = create_new_horse_shoeing_service_booking(booking.model_dump())
