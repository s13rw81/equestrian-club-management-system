...
def update_logistics_company(company_id: str, update_company: UpdateCompanyModel):
    ...
    updated_logictic_company = LogisticCompanyInternal(
        ...
        description=update_company_dict['description'] if 'description' in update_company_dict and update_company_dict['description'] else company['description'],
        is_khayyal_verified=update_company_dict['is_khayyal_verified'] if 'is_khayyal_verified' in update_company_dict and update_company_dict['is_khayyal_verified'] else company['is_khayyal_verified'],
