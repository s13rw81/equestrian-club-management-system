...
from config import DATABASE_NAME, DATABASE_MAX_POOL_SIZE, DATABASE_URL, DATABASE_PASSWORD, DATABASE_USER
...
CONNECTION_STRING = f"mongodb://{ESCAPED_DATABASE_USERNAME}:{ESCAPED_DATABASE_PASSWORD}@{DATABASE_URL}:27017"
